...
The game was implemented in JavaScript with HTML/CSS layout. Globally there are two classes `Cell` and `Game`. User creates an initial configuration restarting the page or by clicking the button `randomize`.
